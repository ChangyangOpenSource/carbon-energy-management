...
export default {
  ...
  methods: {
    download() {
      window.open(
        location.protocol + "//" + location.host + "/download/抄表记录.xlsx"
      );
    },
    handleCancel() {},
    handleOk() {
    ...
    searchQuery() {
      ...
      console.log(this.selectMotiorTime, "时间");
      this.getMeterMeter(parameter);
    },
    searchReset() {
      ...
      (this.selectMotiorTime = undefined), this.getMeterMeter();
    },
    handleChange(value) {
