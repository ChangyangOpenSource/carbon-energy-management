<template>
  <div class="bg tables">
    ...
    <div class="right">
      <div class="right-top">
        <eacharts :type="4" @onTime="onTime" :topList="topList" />
      </div>
      <div class="right-bottom">
        <a-table
          :pagination="false"
          :columns="columns"
          :data-source="topList.data"
          :scroll="{ y: 240 }"
...
import { carbonFootprintlist, getByType } from "@/api/tanpai.js";
export default {
  ...
  methods: {
    ...
    carbonFootprintlist() {
      carbonFootprintlist(this.from).then((res) => {
        if (res.code == 200) {
          console.log(res,'carbonFootprintlist')
