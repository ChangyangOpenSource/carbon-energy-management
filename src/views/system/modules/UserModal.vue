  ...
  >
      ...
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        >
          <a-radio-group v-model="model.userIdentity" @change="identityChange">
            <a-radio  :value="1"> <span class="tiShiColor">普通用户</span> </a-radio>
            <a-radio :value="2"><span class="tiShiColor">上级</span> </a-radio>
          </a-radio-group>
        </a-form-model-item>
        <a-form-model-item
          label="负责部门"
    ...
    <div class="drawer-bootom-button" v-show="!disableSubmit">
      <a-popconfirm
        ...
        cancelText="取消"
      >
        <a-button class="buttton2" style="margin-right: 0.8rem">取消</a-button>
      </a-popconfirm>
