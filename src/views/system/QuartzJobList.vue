...
<!--      </a-upload>-->
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              ...
              <a-menu-item><a @click="showModal(record)">查看记录</a></a-menu-item>
              <a-menu-item>
    ...
    <a-modal v-model="visible" title="任务记录" @ok="handleOk" width = 600>
      <timed-task-record-list :jobClassName="jobClassName" v-if="visible"></timed-task-record-list>
    </a-modal>
  </a-card>
</template>
...
<script>
  ...
  import TimedTaskRecordList from "@views/system/modules/TimedTaskRecordList.vue";
...
/*            customRender:function (text) {
    ...
    methods: {
      showModal(record) {
        this.jobClassName = record.jobClassName
        this.visible = true;
      },
